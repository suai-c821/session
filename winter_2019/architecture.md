...
DMA (Direct Memory Access) - это режим обмена данных между устройствами или между устройствами и памятью RAM без участия CPU. В результате увеличивается скорость передаёт информацию, так как данные не пересылаются в CPU и обратно
