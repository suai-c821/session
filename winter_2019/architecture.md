...
3. Электрический признак
    ...
    Основан на порогов эффекте в полупроводниковых средствах. Для изменения состояния памяти требуется некоторая электрическая энергия. Существует несколько видов данной памяти:
